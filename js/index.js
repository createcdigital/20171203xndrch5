...
var pH = $("#page").height();
var pW = $("#page").width();
$(".light1").css({"height":pH+"px","width":pW+"px"});

var pageNext = function () {
    getIntegral(apiUrl,'11011','打开活动链接获取积分',1);
    $('#page').turn('next');
}
...
wx.ready(function () {
    wx.onMenuShareTimeline({
        title: 'nieva', // 分享标题
        link: "http://nivea.fphis.com/crm/xndrc-n/share.html", // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
        imgUrl: 'http://nivea.fphis.com/crm/xndrc-n/img/logo.png', // 分享图标
        success: function () {
            getIntegral(apiUrl,'11012','内容分享获取积分',2);
